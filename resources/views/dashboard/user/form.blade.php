                    ...
                    <div class="form-validation">
                        <form class="form-valide"
                            ...
                            <div class="row ">
                                ...
                                <div class="col-xl-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select id="single-select" name="role"
                                                    class="col-12">
                                                <option
                                                    {{((isset($user) && $user->role=='admin' )?'selected' : '')}} value="admin">
                                                    مدیر
                                                </option>
                                                <option
                                                    {{((isset($user) && $user->role=='user' )?'selected' : '')}} value="user">
                                                    کاربر
                                                </option>
                                ...
                                <div class="col-xl-6">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label text-center" for="isActive">فعال ؟
                                        </label>
                                        <div class="col-lg-6">
                                            <div class="col">
                                                <div class="custom-control custom-checkbox mb-3 checkbox-success">
                                                    <input type="checkbox" class="custom-control-input"
                                                           {{((isset($user) && $user->isActive )?'checked' : '')}}

                                                           id="isActive" name="isActive">
                                                    <label class="custom-control-label" for="isActive">بله</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="col-lg-3 ">
            <div class="card ">
                ...
                <div class="card-body text-center">
                    @if(isset($user))
                        <img class="img-fluid rounded-circle" src="{{asset('storage/images/profiles/'.$user->id.'/'.$user->pic)}}">
                    @else
