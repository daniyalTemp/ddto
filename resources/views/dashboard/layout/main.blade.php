            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a  href="{{route('dashboard.blog.list')}}" aria-expanded="false">پست ها</a>

                            </li>
                            <li><a  href="{{route('dashboard.blog.category.list')}}" aria-expanded="false">دسته بندی وبلاگ</a>
                    ...
                    <li class="nav-label">دفترچه تلفن</li>
                    <li><a class="has-arrow ai-icon" href="{{route('dashboard.phoneBook.list')}}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <span class="nav-text">دفترچه تلفن</span>
                        </a>
