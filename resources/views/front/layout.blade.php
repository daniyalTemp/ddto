        ...
        <div class="container">
            <div class="about-inner d-flex">
                <div class="about-col-left">
                    <img style="width: 50%;
                        height: 50%;
                        margin-right: 15%;" src="assets/images/Archlinux-icon-crystal-64.svg.png" alt="about">
                </div>
        ...
        <div class="container">
            ...
            <div class="services-inner d-grid">
                ...
                <div class="services-block">
                    ...
                    <h3>طراحی مدل‌های ترند و خاص</h3>
                ...
                <div class="services-block">
                    <div class="service-icon color2 d-flex">
                        <img src="assets/images/services/print.svg" style="width: 80%;" alt="web dev">
                    </div>
                    <h3>چاپ ایده‌ها</h3>
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است
                        چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی
                ...
                <div class="services-block">
                    <div class="service-icon color3 d-flex">
                        <img src="assets/images/services/idea.svg" style="  height: 80%;" alt="illustration">
                    </div>
                    <h3>تولید محصولات خاص </h3>
                    <p>هر آنچه شما به آن فکر کنید ما برای شما میسازیم... </p>
                </div>
                <!-- item -->
                <div class="services-block">
                    <div class="service-icon color4 d-flex">
                        <img src="assets/images/services/online-shop.svg" style="  height: 75%;" alt="SEO ">
                    </div>
                    <h3>فروشگاه </h3>
                    <p>نمونه های چاپ شده اماده برای فروش با قیمت اقتصادی </p>
                </div>
                <!-- item -->
                <div class="services-block">
                ...
                <div class="services-block">
                    ...
                    <h3>جنده بازی ( برای این ایده بدید ) </h3>
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است
                        چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی
                        تکنولوژی مورد نیاز </p>
                </div>
...
<div class="modal-container">
    <div class="modal">
        ...
        <div class="modal-content">
            ...
            <p class="requirments">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان
                گرافیک است </p>

            <ul>
                <li><span>مهارت ها:-</span> HTML, CSS, BOOTSTRAP 4, JAVASCRIPT, FIGMA, PHOTOSHOP</li>
                <li><span>زمان اتمام پروژه:-</span>15 days</li>
                <li><span>آدرس پروژه:-</span> <a href="https://netcopy.ir">https://netcopy.ir</a>
                </li>
            </ul>
